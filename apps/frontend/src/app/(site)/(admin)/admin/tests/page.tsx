            ...
            <TableBody>
              {tests ? tests?.map((test) => (
                <TableRow key={test.testId}>
                  ...
                  <TableCell>
                    <Button variant="ghost" size="default" className="hover:underline" asChild>
                      <Link href={`/tests/edit/${test.id}`}>Edit</Link>
                    </Button>
                    <Dialog>
                      <DialogTrigger className="text-xm text-red-500 hover:underline">Delete</DialogTrigger>
                      <DialogContent className="bg-white p-4 rounded-md">
                        ...
                        <DialogFooter >
                          <DialogClose className="outline-dashed">Cancel</DialogClose>
                          <Button onClick={() => handleDelete(test.testId)} >Confirm Delete</Button>
                        </DialogFooter>
                      </DialogContent>
                    </Dialog>
