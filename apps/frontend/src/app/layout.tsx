...
export const metadata: Metadata = {
  title: "RankMarg | Your Personal AI Practice Coach for JEE & NEET ",
  description: "RankMarg acts as your personal AI Practice coach for JEE & NEET—analyzing mistakes, tracking mastery, planning revisions, and guiding daily practice to maximize rank improvement.",
  keywords: [
    "RankMarg",
    "RankMarg AI Coach",
    "JEE Personal Practice Coach",
    "NEET Personal Practice Coach",
    "JEE Practice",
    "NEET Preparation",
  ...
  openGraph: {
    title: "RankMarg | Your Personal AI Practice Coach for JEE & NEET ",
    description:
      "An AI-driven personal practice coach for JEE & NEET aspirants—guiding what to practice, when to revise, and how to fix mistakes for consistent rank growth.",
