...
export const routeConfigs: RouteConfig[] = [
  ...
  { path: "/test/:testId", type: RouteType.DYNAMIC, access: AccessLevel.PUBLIC, description: "Take test" },
  { path: "/test/:testId/instructions", type: RouteType.DYNAMIC, access: AccessLevel.PUBLIC, description: "Test instructions" },
