// Local enums file for mobile app
// This mirrors the enums from @repo/db/enums for mobile compatibility
...
export type TestParticipationStatus = (typeof TestParticipationStatus)[keyof typeof TestParticipationStatus];
